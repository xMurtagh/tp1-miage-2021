...
* Forker sur Github le projet `bflorat/tp1-miage-2020` (bouton GitHub 'Fork') puis cloner votre dépôt Github dans votre workspace. Attention : *un seul fork par monôme/binôme*  ;
* Télécharger l'image VirtualBox de l'environnement de développement https://public.florat.net/cours_miage/vm-tp-miage.zip[ici] (la télécharger et la tester *avant le TP*). Le login/mot de passe est : `tp`/`tp`.
